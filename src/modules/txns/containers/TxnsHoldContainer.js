...
const TxnsHoldContainer = ({
  ...
  const lastSearchedItem = JSON.parse(sessionStorage.getItem("lastSearchedItem"));
        ...
        <Col xs={12} className={"mb-8"}>
          <BaseBreadcrumb
            items={[
              ...
              { id: 2, name: "On Hold", url: "/txns/hold" },
            ]}
          />
        </Col>
        <Col xs={12}>
                ...
                <Flex>
                  ...
                  <BaseInput
                    ...
                    handleInput={(val) => {
                      ...
                      sessionStorage.setItem("lastSearchedItem", JSON.stringify(val))
                    }}

...
const TxnsFailedContainer = ({
  ...
  const lastSearchBox = JSON.parse(sessionStorage.getItem("lastSearchBox"));
        ...
        <Col xs={12} className={"mb-8"}>
          <BaseBreadcrumb
            items={[
              ...
              { id: 2, name: "Failed", url: "/txns/failed" },
            ]}
          />
        </Col>
        <Col xs={12}>
                ...
                <Flex>
                  ...
                  <BaseInput
                    ...
                    handleInput={(val) => {
                      ...
                      sessionStorage.setItem("lastSearchBox", JSON.stringify(val));
                    }}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(TxnsFailedContainer));

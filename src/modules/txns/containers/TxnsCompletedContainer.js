...
const TxnsCompletedContainer = ({
  ...
  const searchItem = JSON.parse(sessionStorage.getItem("searchItem"));
        ...
        <Col xs={12} className={"mb-8"}>
          <BaseBreadcrumb
            items={[
              ...
              { id: 2, name: "Completed", url: "/txns/completed" },
            ]}
          />
        </Col>
        <Col xs={12}>
                ...
                <Flex>
                  ...
                  <BaseInput
                    ...
                    handleInput={(val) => {
                      ...
                      sessionStorage.setItem("searchItem", JSON.stringify(val))
                    }}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(TxnsCompletedContainer));

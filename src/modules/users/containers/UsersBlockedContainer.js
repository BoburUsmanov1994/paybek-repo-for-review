...
const UsersBlockedContainer = ({
  ...
  const lastSearchField = JSON.parse(sessionStorage.getItem("lastSearchField"));
  ...
  const [filter, setFilter] = useState({
    status: "BLOCKED",
    searchingField: lastSearchField || "",
    cardBrand: "",
    countryId: "",
    lastActiveDays: 30,
                ...
                <Flex>
                  <BaseInput
                    ...
                    handleInput={(val) => {
                      ...
                      sessionStorage.setItem("lastSearchField", JSON.stringify(val));
                    }}
                  />
                  <BaseSelect
                    defaultValue={30}
